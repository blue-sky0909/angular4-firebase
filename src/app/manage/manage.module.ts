...
const routes: Routes = [
    ...
    {path: 'organized', component: OrganizedComponent, children: [
    ...
    {path: 'promoted', component: PromotedComponent, children: [
    ...
    {path:'promoted/:id', component: ManagePromotedComponent, children: [
    ...
    {path: 'attending', component: RegistrationsComponent, children: [
