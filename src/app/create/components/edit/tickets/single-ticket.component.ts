    ...
    template: `
        ...
        <td>
            <div class="row"> 
                ...
                <div class="col-md-2"> 
                    <input [(ngModel)]="ticket.ticketQuantity" type="number" class="form-control" (blur)="saveTicket()" >    
                </div>
                <div class="col-md-2"> 
                    <div class="input-group" *ngIf="ticket.ticketType == 'paid'">
                        <div class="input-group-addon">$</div>
                        <input [ngModel]="ticket.ticketPrice" type="number" (ngModelChange)="ticket.ticketPrice=$event" class="form-control" style="margin-left:-3px;" (blur)="saveTicket()" >
                    </div>    
                </div>
...
export class SingleTicketComponent implements OnInit{
    ...
    removeTicket(){
        ...
        this.deleteTicket.emit(this.ticketKey);
    }
    ...
    saveTicket(){
        ...
        this.updateTicket.emit({value:ticket, key: this.ticketKey});
