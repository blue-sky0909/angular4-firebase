import { Component, AfterContentInit, OnInit, Output, EventEmitter } from '@angular/core';
...
export class EditDescriptionComponent implements OnInit, AfterContentInit{
    ...
    @Output() updateDes = new EventEmitter();
    ...
    saveContent() {
        ...
        if(this.descriptionText.length){
            ...
            this.updateDes.emit({description: this.description, descriptionText: this.descriptionText});
