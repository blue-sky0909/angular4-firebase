...
export class MyEventInvitationsComponent implements OnInit, AfterViewInit
{
    ...
    setDefaults(){
        let description = this.eventService.event.description;
    ...
    saveTemplateDraft(){
      let draft ={
        'invite-template': this.inviteTemplate,
        'invite-mail' : this.inviteEmails
      }
      this.eventService.addEmailTemplateDraft(draft);
    }
