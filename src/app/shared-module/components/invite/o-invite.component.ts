       ...
       <div>
           ...
           <div class="input-group">
               ...
               <span class="input-group-btn">
                    <button id="copy-link" data-clipboard-target="#link" class="btn btn-primary" (click)="copy()"><i class="fa fa-files-o"></i> <span *ngIf="!hideButtonText">Copy to Clipboard</span></button>
               </span>
           </div>
...
export class ManageInviteComponent implements OnInit, AfterViewChecked{
    ...
    createLink(){
        if(typeof this.ocode !== "undefined"){
            this.link = `${this.appService.environment}/event/${this.eventId};ocode=${this.ocode}`;
        }
        else{
            this.link = `${this.appService.environment}/event/${this.eventId}`;
        }
